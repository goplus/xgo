...
`, `/foo/bar.gox:2:4: whitespace is not allowed in static value name`, ``)
	testErrCode(t, `var (
	.B int
)
...
`, `/foo/bar.xgo:2:5: whitespace is not allowed in static value name`, ``)
	testErrCode(t, `var (
	A .B int
)
`, `/foo/bar.xgo:2:4: whitespace is not allowed in static value name`, ``)
}
